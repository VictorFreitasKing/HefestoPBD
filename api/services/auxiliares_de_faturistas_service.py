...
def getAll():
    ...
    while data_manager is not None:
        lista.append(auxiliares_de_faturistas.Auxiliares_de_Faturista(codigo=data_manager[0], matriculaFuncionario=data_manager[1]))
        data_manager = cursor.fetchone()
...
def get(id):
    ...
    data_manager = cursor.fetchone()
    if data_manager:
        return auxiliares_de_faturistas.Auxiliares_de_Faturista(codigo=data_manager[0], matriculaFuncionario=data_manager[1])
    else:
        return None
