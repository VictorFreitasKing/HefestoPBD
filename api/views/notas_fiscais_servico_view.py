...
class notas_fiscais_servico_view():
    def getAll(self):
        notas_fiscais_servicos = notas_fiscais_servico_service.getAll()
    ...
    def post(self, notas_fiscais_servico):
        if notas_fiscais_servico_service.cadastrar(notas_fiscais_servico):
            return make_response(notas_fiscais_servico_service.get_ultimo().toJson(), 201)
        else:
            return make_response({}, 200)
    def get(self, id):
        notas_fiscais_servico = notas_fiscais_servico_service.get(id)
